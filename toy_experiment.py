...
if __name__ == '__main__':
    ...
    parser.add_argument('--datanum', type = int, default = 50000, help = 'Number of dataset')
    parser.add_argument('--kth', type = int, default = 4, help = 'hyperparameter for KNN')
    parser.add_argument('--scale', type = int, default= 1.5, help = 'hyperparameter for hypersphere f')
